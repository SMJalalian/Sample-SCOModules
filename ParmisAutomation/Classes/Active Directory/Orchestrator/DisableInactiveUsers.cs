...
{
    [Activity("Disable Inactive Users")]
    class DisableInactiveUsers : ADDomain
    {
        ...
        public void Run()
        {
            ...
            {
                if (Orc_DC != null)
                    DisableInactiveUsers(Orc_DC, Orc_SearchLoc, Orc_InactiveDays);
                else
                    DisableInactiveUsers(Orc_SearchLoc, Orc_InactiveDays);
                Orc_Result = true;
            }
            catch (Exception)
            {
